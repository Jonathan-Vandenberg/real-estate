...
export default function Blog({ offerIn, documents }: IOfferIn) {
  ...
  return (
    <div className="flex">
      ...
      <div className="flex flex-col items-center p-3 md:items-start justify-between h-[calc(100vh_-_var(--navigation-height))] w-[5rem]  md:w-[20rem] sticky top-navigation-height bg-white">
        <div className="flex-1 border-r border-off-white xl:border-none md:pr-4">
