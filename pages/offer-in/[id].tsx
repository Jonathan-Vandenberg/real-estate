...
export default function Blog({ offerIn, documents }: IOfferIn) {
  ...
  return (
    <div className="flex">
      ...
      <div className="flex flex-col items-start justify-between h-[calc(100vh_-_var(--navigation-height))] sticky top-navigation-height bg-white">
        <div className="flex-1 border-r-2 border-off-white">
          <ul className="pt-2 pb-4 space-y-2 px-2 text-sm">
