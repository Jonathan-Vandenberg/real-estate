...
import { Property, Image, Agent } from "../types";
...
export default function AdminDash({
  ...
  return (
    <div className="border-r-white border-r-2 flex bg-white-off-white w-full min-h-[calc(100vh_-_var(--navigation-height))]">
      <div className="flex flex-col min-h-[calc(100vh_-_var(--navigation-height))] p-3 w-[30rem] bg-white border-r-white border-r-2 sticky top-navigation-height  sticky top-0">
          ...
          <div className="flex-1">
            <ul className="pt-2 pb-4 space-y-1 text-sm">
              <li className=" hover:bg-off-white rounded-lg">
                <div
                  onClick={() => {
                    setUsers(false), setListings(true);
                  }}
              ...
              <li className="hover:bg-off-white rounded-lg">
                <div
                  className="flex items-center p-2 space-x-3 rounded-md hover:cursor-pointer"
                  onClick={() => {
                    setUsers(true), setListings(false);
                  }}
                >
        ...
        <div className="flex-col items-center p-2 space-y-2 justify-center hidden md:flex">
          {session?.user?.image && (
            <img
        ...
        <div className=" flex-col items-start justify-end h-full space-y-1 text-sm shadow-[rgb(230,63,213)] text-[rgb(230,63,213)]  hidden md:flex">
          <p
            ...
            className="hover:cursor-pointer rounded-full border border-2-[rgb(230,63,213)] px-2 mb-1"
          >
            FeelGoodCorner
          </p>
          {feelGood && <JokeCard />}
