...
import { Images, useUpdateImagesMutation } from "../types";
    ...
    variables: {
      input: {
        ...
        interiorImage1: fileNames[0]
          ...
          : "",
        interiorImage2: fileNames[1]
          ? `https://landmark-real-eastate.s3.ap-southeast-1.amazonaws.com/${fileNames[1]}`
          : "",
        interiorImage3: fileNames[2]
          ? `https://landmark-real-eastate.s3.ap-southeast-1.amazonaws.com/${fileNames[2]}`
          : "",
        interiorImage4: fileNames[3]
          ? `https://landmark-real-eastate.s3.ap-southeast-1.amazonaws.com/${fileNames[3]}`
          : "",
      },
    },
  };
