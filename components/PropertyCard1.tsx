...
export default function PropertyCard1({ property, image }: IProps) {
  return (
    <>
          ...
          {property.map((listing, i) => (
            ...
            >
              <div className="shadow p-4 rounded-lg bg-white">
                ...
                <div className="mt-4">
                  <h2
                    className="font-medium text-base text-md md:text-lg text-gray-800 line-clamp-1"
                    title={listing!.title}
                  >
                    {listing!.title}
                  </h2>
                  <p
                    className="mt-2 text-md text-gray-800 line-clamp-1"
                ...
                <div className="grid grid-cols-2 grid-rows-2 gap-4 mt-8">
                  ...
                  <div className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                    ...
                    {/**TODO Calculator */}
                    <span className="mt-2 xl:mt-0 text-sm">$1.98 /sq.ft</span>
                  </div>
                </div>
                    ...
                    <div className="relative">
                      <div className="md:w-8 md:h-8">
                        <img
                          ...
                          src="/Users/jonathanvandenberg/2023/real-estate/public/heroImage.jpeg"
                          alt=""
                        />
                      </div>
                      <span className="absolute top-0 right-0 inline-block w-3 h-3 bg-[rgb(67,230,84)] rounded-full"></span>
                    </div>
